...
# Plotagem
#
def plot_graph(G, title="", highlight_seq=None):
    ...
    if highlight_seq and len(highlight_seq) > 1:
        ...
        nx.draw_networkx_nodes(G, pos, nodelist=highlight_seq, node_size=600, node_color="orange")
    plt.show()
...
plot_graph(G1, "Menor caminho de A a E", highlight_seq=shortest)
